...
const Dashboard = () => {
  ...
  const { data: dashboardStats, loading, error, usingFallback } = useFetchWithFallback('/api/admin/dashboard', token);
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-2xl font-bold text-gray-900">{dashboardStats?.totalClubs || 0}</div>
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-2xl font-bold text-gray-900">{dashboardStats?.totalStudents || 0}</div>
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-2xl font-bold text-gray-900">{dashboardStats?.pendingRequests || 0}</div>
                  </dd>
                </dl>
              </div>
            </div>
